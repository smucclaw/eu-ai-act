...
[Sharing of information on incidents and malfunctioning]{.smallcaps}
...
1.  ### FRAMEWORK OF THE PROPOSAL/INITIATIVE
    ...
    2.  Policy area(s) concerned

    3.  The proposal/initiative relates to:
    ...
    4.  Objective(s)
        ...
        3.  Expected result(s) and impact

        4.  Indicators of performance

    5.  Grounds for the proposal/initiative

        1.  Requirement(s) to be met in the short or long term including a detailed timeline for roll-out of the implementation of the initiative

        2.  Added value of Union involvement (it may result from different factors, e.g. coordination gains, legal certainty, greater effectiveness or complementarities). For the purposes of this point \'added value of Union involvement\' is the value resulting from Union intervention which is additional to the value that would have been otherwise created by Member States alone

        3.  Lessons learned from similar experiences in the past

        4.  Compatibility with the Multiannual Financial Framework and possible synergies with other appropriate instruments

1.5.5 Assessment of the different available financing options, including scope for redeployment

6.  Duration and financial impact of the proposal/initiative

7.  Management mode(s) planned
...
2.  ### MANAGEMENT MEASURES
    ...
    2.  Management and control system
        ...
        1.  Justification of the management mode(s), the funding implementation mechanism(s), the payment modalities and the control strategy proposed

        2.  Information concerning the risks identified and the internal control system(s) set up to mitigate them

        3.  Estimation and justification of the cost-effectiveness of the controls (ratio of \"control costs ÷ value of the related funds managed\"), and assessment of the expected levels of risk of error (at payment & at closure)

    3.  Measures to prevent fraud and irregularities

3.  ### ESTIMATED FINANCIAL IMPACT OF THE PROPOSAL/INITIATIVE

    1.  Heading(s) of the multiannual financial framework and expenditure budget line(s) affected

    2.  Estimated financial impact of the proposal on appropriations

        1.  *Summary of estimated impact on operational appropriations*

        2.  *Estimated output funded with operational appropriations*

        3.  *Summary of estimated impact on administrative appropriations*

        4.  *Compatibility with the current multiannual financial framework*

        5.  *Third-party contributions*

    3.  Estimated impact on revenue
...
2.  #### Grounds for the proposal/initiative
    ...
    5.  *Assessment of the different available financing options, including scope for redeployment*

3.  #### Duration and financial impact of the proposal/initiative
...
2.  #### Management and control system(s)

    1.  *Justification of the management mode(s), the funding implementation mechanism(s), the payment modalities and the control strategy proposed*

    2.  *Information concerning the risks identified and the internal control system(s) set up to mitigate them*

    3.  *Estimate and justification of the cost-effectiveness of the controls (ratio of \"control costs ÷ value of the related funds managed\"), and assessment of the expected levels of risk of error (at payment & at closure)*
...
[In order]{.ul} of multiannual financial framework headings and budget lines.

+--------------------------------------------+------------------------------------------------------------------+---------------------+--------------+--------------------------+----------------------+--------------------------------------------------------------------+
| Heading of multiannual financial framework | Budget line                                                      | Type of expenditure | Contribution |                          |                      |                                                                    |
+============================================+==================================================================+=====================+==============+==========================+======================+====================================================================+
|                                            | Number                                                           | Diff./Non- diff.66  | from EFTA    | from candidate countr 68 | from third countries | within the meaning of Article 21(2)(b) of the Financial Regulation |
|                                            |                                                                  |                     |              |                          |                      |                                                                    |
|                                            |                                                                  |                     | countries    | ies                      |                      |                                                                    |
|                                            |                                                                  |                     |              |                          |                      |                                                                    |
|                                            |                                                                  |                     | 67           |                          |                      |                                                                    |
...
1.  #### Estimated financial impact of the proposal on appropriations

    1.  *Summary of estimated impact on expenditure on operational appropriations*
...
<table><thead><tr class="header"><th><p>DG: CNECT</p></th><th></th><th></th><th></th><th><p>Year</p><p>2022</p></th><th><p>Year</p><p>2023</p></th><th><p>Year</p><p>2024</p></th><th><p>Year</p><p>2025</p></th><th><p>Year</p><p>2026</p></th><th><p>Year</p><p>202769</p></th><th><p>TOTAL</p></th></tr></thead><tbody><tr class="odd"><td><ul><li><p>Operational appropriations</p></li></ul></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr><tr class="even"><td><p>Budget line<sup>70</sup> 02 04 03</p></td><td><p>Commitments</p></td><td><p>(1a)</p></td><td></td><td><p>1.000</p></td><td></td><td></td><td></td><td></td><td></td><td>1.000</td></tr><tr class="odd"><td></td><td><p>Payments</p></td><td><p>(2a)</p></td><td></td><td><p>0.600</p></td><td><p>0.100</p></td><td><p>0.100</p></td><td><p>0.100</p></td><td><p>0.100</p></td><td></td><td>1.000</td></tr><tr class="even"><td><p>Budget line</p></td><td><p>Commitments</p></td><td><p>(1b)</p></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr><tr class="odd"><td></td><td><p>Payments</p></td><td><p>(2b)</p></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr><tr class="even"><td><p>Appropriations of an administrative nature financed from the envelope of specific programmes<sup>71</sup></p></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr><tr class="odd"><td><p>Budget line 02 01 30 01</p></td><td></td><td><p>(3)</p></td><td></td><td>0.240</td><td>0.240</td><td>0.240</td><td>0.240</td><td>0.240</td><td></td><td>1.200</td></tr><tr class="even"><td><p>TOTAL appropriations for DG CNECT</p></td><td><p>Commitments</p></td><td><p>=1a+1b +3</p></td><td></td><td>1.240</td><td></td><td>0.240</td><td>0.240</td><td>0.240</td><td></td><td>2.200</td></tr><tr class="odd"><td></td><td><p>Payments</p></td><td><p>=2a+2b</p><p>+3</p></td><td></td><td>0.840</td><td>0.340</td><td>0.340</td><td>0.340</td><td>0.340</td><td></td><td>2.200</td></tr></tbody></table>
...
<table><thead><tr class="header"><th><ul><li><p>TOTAL operational appropriations</p></li></ul></th><th><p>Commitments</p></th><th><p>(4)</p></th><th></th><th>1.000</th><th></th><th></th><th></th><th></th><th></th><th>1.000</th></tr></thead><tbody><tr class="odd"><td></td><td><p>Payments</p></td><td><p>(5)</p></td><td></td><td>0.600</td><td>0.100</td><td>0.100</td><td>0.100</td><td>0.100</td><td></td><td>1.000</td></tr><tr class="even"><td><ul><li><p>TOTAL appropriations of an administrative nature financed from the envelope for specific programmes</p></li></ul></td><td><p>(6)</p></td><td></td><td>0.240</td><td>0.240</td><td>0.240</td><td>0.240</td><td>0.240</td><td></td><td>1.200</td><td></td></tr><tr class="odd"><td><p>TOTAL appropriations under HEADING 1</p><p>of the multiannual financial framework</p></td><td><p>Commitments</p></td><td><p>=4+ 6</p></td><td></td><td>1.240</td><td>0.240</td><td>0.240</td><td>.0.240</td><td>0.240</td><td></td><td>2.200</td></tr><tr class="even"><td></td><td><p>Payments</p></td><td><p>=5+ 6</p></td><td></td><td>0.840</td><td>0.340</td><td>0.340</td><td>0.340</td><td>0.340</td><td></td><td>2.200</td></tr></tbody></table>

If more than one heading is affected by the proposal / initiative, repeat the section above:

<table><thead><tr class="header"><th><ul><li><p>TOTAL operational appropriations (all operational headings)</p></li></ul></th><th><p>Commitments</p></th><th><p>(4)</p></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th></tr></thead><tbody><tr class="odd"><td></td><td><p>Payments</p></td><td><p>(5)</p></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr><tr class="even"><td><ul><li><p>TOTAL appropriations of an administrative nature financed from the envelope for specific programmes (all operational headings)</p></li></ul></td><td><p>(6)</p></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr><tr class="odd"><td><p>TOTAL appropriations</p></td><td><p>Commitments</p></td><td><p>=4+ 6</p></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr><tr class="even"><td><p>under HEADINGS 1 to 6</p></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr><tr class="odd"><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr><tr class="even"><td><p>of the multiannual financial framework</p><p>(Reference amount)</p></td><td><p>Payments</p></td><td><p>=5+ 6</p></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr></tbody></table>

  -------------------------------------------- --- ------------------------------
  Heading of multiannual financial framework   7   'Administrative expenditure'
  -------------------------------------------- --- ------------------------------

This section should be filled in using the \'budget data of an administrative nature\' to be firstly introduced in the [[Annex to the Legislative]{.ul}](https://myintracomm.ec.europa.eu/budgweb/EN/leg/internal/Documents/2016-5-legislative-financial-statement-ann-en.docx) [[Financial Statement]{.ul}](https://myintracomm.ec.europa.eu/budgweb/EN/leg/internal/Documents/2016-5-legislative-financial-statement-ann-en.docx) (Annex V to the internal rules), which is uploaded to DECIDE for interservice consultation purposes.

EUR million (to three decimal places)

+----------------------------------------+--------------------------------------+-------+-------+-------+-----------+--------------+-------+-------+
|                                        | Year                                 | Year  | Year  | Year  | Year 2027 | After 202 72 | TOTAL |       |
|                                        |                                      |       |       |       |           |              |       |       |
...
+----------------------------------------+--------------------------------------+-------+-------+-------+-----------+--------------+-------+-------+
| TOTAL appropriations under HEADING 7   | (Total commitments = Total payments) | 1.530 | 1.530 | 1.530 | 1.530     | 1.530        | 1.530 | 7.650 |
|                                        |                                      |       |       |       |           |              |       |       |
...
<table><thead><tr class="header"><th></th><th><p>Year</p><p>2022</p></th><th><p>Year</p><p>2023</p></th><th><p>Year</p><p>2024</p></th><th><p>Year</p><p>2025</p></th><th><p>Year 2026</p></th><th><p>Year 2027</p></th><th></th><th><p>TOTAL</p></th><th></th></tr></thead><tbody><tr class="odd"><td><p>TOTAL appropriations</p></td><td><p>Commitments</p></td><td></td><td><p>2.770</p></td><td><p>1.770</p></td><td><p>1.770</p></td><td><p>1.770</p></td><td><p>1.770</p></td><td></td><td>9.850</td></tr></tbody></table>



+----------------------------------------+----------+---+-------+-------+-------+-------+-------+-------+
| under HEADINGS 1 to 7                  | Payments |   | 2.370 | 1.870 | 1.870 | 1.870 | 1.870 | 9.850 |
|                                        |          |   |       |       |       |       |       |       |
| of the multiannual financial framework |          |   |       |       |       |       |       |       |
+----------------------------------------+----------+---+-------+-------+-------+-------+-------+-------+

1.  *Estimated output funded with operational appropriations*

Commitment appropriations in EUR million (to three decimal places)

<table><thead><tr class="header"><th><p>Indicate objectives and outputs</p><p></p></th><th></th><th></th><th><p>Year</p><p>2022</p></th><th><p>Year</p><p>2023</p></th><th><p>Year</p><p>2024</p></th><th><p>Year</p><p>2025</p></th><th><p>Year</p><p>2026</p></th><th><p>Year</p><p>2027</p></th><th><p>After</p><p>202 73</p><p>7</p></th><th><p>TOTAL</p></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th></tr></thead><tbody><tr class="odd"><td></td><td><p>OUTPUTS</p></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr><tr class="even"><td></td><td><p>Type</p></td><td><p>Average cost</p></td><td><p>No</p></td><td><p>Cost</p></td><td><p>No</p></td><td><p>Cost</p></td><td><p>No</p></td><td><p>Cost</p></td><td><p>No</p></td><td><p>Cost</p></td><td><p>No</p></td><td><p>Cost</p></td><td><p>No</p></td><td><p>Cost</p></td><td><p>No</p></td><td><p>Cost</p></td><td><p>Tota l No</p></td><td><p>Total cost</p></td></tr><tr class="odd"><td><p>SPECIFIC OBJECTIVE No 174</p><p>…</p></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr><tr class="even"><td><p>Database</p></td><td></td><td></td><td></td><td></td><td><p>1</p></td><td><p>1.000</p></td><td><p>1</p></td><td></td><td>1</td><td></td><td>1</td><td></td><td><p>1</p></td><td></td><td><p>1</p></td><td><p>0.100</p></td><td><p>1</p></td><td><p>1.000</p></td></tr><tr class="odd"><td><p>Meetings- Output</p></td><td></td><td></td><td></td><td></td><td><p>10</p></td><td><p>0.200</p></td><td><p>10</p></td><td><p>0.200</p></td><td>10</td><td><p>0.200</p></td><td>10</td><td><p>0.200</p></td><td><p>10</p></td><td><p>0.200</p></td><td><p>10</p></td><td><p>0.200</p></td><td><p>50</p></td><td><p>1.000</p></td></tr><tr class="even"><td><p>Communication activities</p></td><td></td><td></td><td></td><td></td><td><p>2</p></td><td><p>0.040</p></td><td><p>2</p></td><td><p>0.040</p></td><td>2</td><td><p>0.040</p></td><td>2</td><td><p>0.040</p></td><td><p>2</p></td><td><p>0.040</p></td><td><p>2</p></td><td><p>0.040</p></td><td><p>10</p></td><td><p>0.040</p></td></tr><tr class="odd"><td><p>Subtotal for specific objective No 1</p></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr><tr class="even"><td><p>SPECIFIC OBJECTIVE No 2 ...</p></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr><tr class="odd"><td><p>- Output</p></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr><tr class="even"><td><p>Subtotal for specific objective No 2</p></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr><tr class="odd"><td><p>TOTALS</p></td><td></td><td></td><td><p>13</p></td><td><p>0.240</p></td><td><p>13</p></td><td><p>0.240</p></td><td>13</td><td><p>0.240</p></td><td>13</td><td><p>0.240</p></td><td><p>13</p></td><td><p>0.240</p></td><td><p>13</p></td><td><p>0.100</p></td><td><p>65</p></td><td><p>2.200</p></td><td></td><td></td></tr></tbody></table>





2.  *Summary of estimated impact on administrative appropriations*
...
+---+------+------+------+------+------+------+---------------------+-------+
|   | Year | Year | Year | Year | Year | Year | Yearly after 202 75 | TOTAL |
|   |      |      |      |      |      |      |                     |       |
|   | 2022 | 2023 | 2024 | 2025 | 2026 | 2027 | 7                   |       |
+---+------+------+------+------+------+------+---------------------+-------+
...
1.  Estimated requirements of human resources
...
+--------------------------------------------------------------------+--------------------+------+------+------+------+------+----------------+---+
| *.*                                                                |                    | Year | Year | Year | 2026 | 2027 | After 2027 |   |
|                                                                    |                    |      |      |      |      |      |                |   |
|                                                                    |                    | 2023 | 2024 | 2025 |      |      |                |   |
+====================================================================+====================+======+======+======+======+======+================+===+
...
+--------------------------------------------------------------------+--------------------+------+------+------+------+------+----------------+---+
| XX 01 xx yy zz 79                                                  | \- at Headquarters |      |      |      |      |      |                |   |
+--------------------------------------------------------------------+--------------------+------+------+------+------+------+----------------+---+
|                                                                    | \- in Delegations  |      |      |      |      |      |                |   |
+--------------------------------------------------------------------+--------------------+------+------+------+------+------+----------------+---+
...
+-------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Officials and temporary staff | To prepare a total of 13-16 meetings, draft reports, continue policy work, e.g. regarding future amendments of the list of high-risk AI applications, and maintain relations with Member States' authorities will require four AD FTE and 1 AST FTE. |
|                               |                                                                                                                                                                                                                                                      |
...
1.  *Compatibility with the current multiannual financial framework*
...
+----------------------------------+------+------+------+------+-------------------------------------------------------------------------------------+-------+---+---+
|                                  | Year | Year | Year | Year | Enter as many years as necessary to show the duration of the impact (see point 1.6) | Total |   |   |
|                                  |      |      |      |      |                                                                                     |       |   |   |
|                                  | N80  | N+1  | N+2  | N+3  |                                                                                     |       |   |   |
+==================================+======+======+======+======+=====================================================================================+=======+===+===+
...
+-----------------------+----------------------------------------------------------+-----------------------------------+------+------+------+-------------------------------------------------------------------------------------+---+---+
| Budget revenue line:  | Appropriation s available for the current financial year | 81                                |      |      |      |                                                                                     |   |   |
|                       |                                                          |                                   |      |      |      |                                                                                     |   |   |
|                       |                                                          | Impact of the proposal/initiative |      |      |      |                                                                                     |   |   |
+=======================+==========================================================+===================================+======+======+======+=====================================================================================+===+===+
|                       |                                                          | Year                              | Year | Year | Year | Enter as many years as necessary to show the duration of the impact (see point 1.6) |   |   |
|                       |                                                          |                                   |      |      |      |                                                                                     |   |   |
|                       |                                                          | N                                 | N+1  | N+2  | N+3  |                                                                                     |   |   |
+-----------------------+----------------------------------------------------------+-----------------------------------+------+------+------+-------------------------------------------------------------------------------------+---+---+
| Article ............. |                                                          |                                   |      |      |      |                                                                                     |   |   |
